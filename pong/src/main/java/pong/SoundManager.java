...
public class SoundManager {
    ...
    public void play(boolean score, boolean hit) {
        try {
            ...
            AudioInputStream clipHits = AudioSystem.getAudioInputStream(Main.class.getResource("/resources/"+ hits.get(randomFile) + ".wav"));
            AudioInputStream clipScore = AudioSystem.getAudioInputStream(Main.class.getResource("/resources/"+ scoreSound + ".wav"));
